...
$query = "insert into board (number,title, content, date, hit, ID, PW, file, link ) 
        values(null,'$title', '$content', '$date',0, '$ID', '$PW','$o_name', '$targetFile')";
